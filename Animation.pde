...
class Animation
{
    ...
    {
        imgCount = count;                    // Number of images in the animation (sketch only uses one multi frame animation but re-use the code setting the count to 1)
    ...
    // Displayes the image to the screen
