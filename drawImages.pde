...
void drawGun(float x, float y, float scalar)
{
    ...
    fill    (40, 255, 40);
    rect    (width*(x)      *scalar, height*(y)     *scalar, width*(.04)   *scalar, height*(.01428)*scalar, 3);
    ...
    rect    (width*(x+.016) *scalar, height*(y+.004)*scalar, width*(.007)  *scalar, height*(.02)   *scalar, 5);
    fill    (0, 100, 0);
